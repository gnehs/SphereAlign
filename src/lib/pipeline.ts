...
const USER_MESSAGE_TRANSLATIONS: Record<string, MessageDescriptor> = {
  ...
  "正在建立影像配對圖": msg({ message: "Building the image pair graph", comment: "Backend alignment progress message before feature matching begins." }),
...
const PHASE_LABELS: Record<string, MessageDescriptor> = {
  ...
  "building-pair-graph": msg({ message: "Building pair graph", context: "pipeline phase", comment: "Short label for selecting image pairs before feature matching." }),
